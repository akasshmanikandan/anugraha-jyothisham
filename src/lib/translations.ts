...
const ta: TranslationSet = {
  ...shared,
  nav: { services: "???????", about: "?????? ?????", process: "?????????", voices: "??????????", faq: "?????????", book: "????? ????? ->" },
  hero: {
    ...shared.hero,
    tagline: "2009 ????? | ????????????? ???????????",
    headline: ["??????", "???????????", "???????", "?????"],
  ...
  book: {
    ...
    hoursVal: "??????????? | 08:00 ? 17:00 IST",
    addressVal: "Flat No. 6, Saravana Villa, Meenakshi Street, Perambur, Chennai 600011",
    contactVal: "+91 917 609 6471 | +91 877 823 6182 | WhatsApp ??????????",
  },
  footer: {
    description: "????????? ??? ??????? ??????? ?????? ??????????????? ????????? ?????? ???????.",
    headers: { consultation: "??????", contact: "???????" },
    copyright: "? 2026 ???????? ?????????. ??????? ?????????? ?????????????????.",
    shanti: "??? ?????? ?????? ??????",
  },
};
