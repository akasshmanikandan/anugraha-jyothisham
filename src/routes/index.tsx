      ...
      <footer className="relative overflow-hidden pt-16" style={{ background: "#050F22" }}>
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          ...
          <div className="mt-16 -mb-2">
            <TempleSilhouette lang={lang} prefix={t.seo.altDeityPrefix} />
          </div>
          <div
          ...
          >
            ...
            {/* Developer branding — centered in the copyright bar */}
            <a
              ...
              style={{
                ...
                fontWeight: 300,
                color: "rgba(201,195,176,0.5)",
                textTransform: "uppercase",
                transition: "color 0.3s ease",
              }}
              onMouseEnter={(e) => ((e.currentTarget as HTMLAnchorElement).style.color = "#D4AF37")}
              onMouseLeave={(e) => ((e.currentTarget as HTMLAnchorElement).style.color = "rgba(201,195,176,0.5)")}
            >
...
function TempleSilhouette({ lang = "en", prefix }: { lang?: Language; prefix: string }) {
  const deityNames = {
